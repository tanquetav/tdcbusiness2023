...
docker build -t quarkus/code-with-quarkus-jvm -f src/main/docker/Dockerfile.jvm .

docker build -t distromini -f src/main/docker/Dockerfile.jlink .
...
docker run -it --rm -p 8080:8080 quarkus/code-with-quarkus-distroless
